...
namespace NzolaWebAPI.Migrations
{
    ...
    [Migration("20260611105826_AddRestricoesNomeUtilizadorEGenero")]
    partial class AddRestricoesNomeUtilizadorEGenero
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NzolaWebAPI.Models.FicheiroConteudo", b =>
                {
                    ...
                    b.Property<int>("ConteudoPublicacaoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConteudoPublicacaoId");
            ...
            modelBuilder.Entity("NzolaWebAPI.Models.ConteudoPublicacao", b =>
                {
                    b.HasOne("NzolaWebAPI.Models.Publicacao", "Publicacao")
                        .WithOne("Conteudo")
                        .HasForeignKey("NzolaWebAPI.Models.ConteudoPublicacao", "PublicacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NzolaWebAPI.Models.FicheiroConteudo", b =>
                {
                    b.HasOne("NzolaWebAPI.Models.ConteudoPublicacao", "ConteudoPublicacao")
                        .WithMany("Ficheiros")
                        .HasForeignKey("ConteudoPublicacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ConteudoPublicacao");
                });
